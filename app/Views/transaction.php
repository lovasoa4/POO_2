...
<body>
  ...
  <header class="top-navbar d-flex justify-content-between align-items-center px-4">
    ...
    <div class="top-user d-flex align-items-center gap-3">
  ...
  <aside class="sidebar">
    <ul class="nav flex-column">
      ...
      <li><a href="/afficher" class="active"><i class="bi bi-arrow-left-right"></i> Transactions</a></li>
      <li><a href="/transaction_Credit"><i class="bi bi-arrow-up-right-circle"></i> Crédit</a></li>
      <li><a href="/transaction_Debit"><i class="bi bi-arrow-down-right-circle"></i> Débit</a></li>
      <li><a href="/ajout"><i class="bi bi-plus-circle"></i> Ajouter transaction</a></li>
      <li><a href="/profil"><i class="bi bi-person"></i> Profil</a></li>
    </ul>
  </aside>
